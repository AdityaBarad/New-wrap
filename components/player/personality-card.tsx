...
export function PersonalityCardSlide({
  ...
  return (
    <Shell>
      ...
      {/* Decorative elements (Same as Wrapped2023Slide) */}
      ...
      {/* 2. Spiky Star Burst (Bottom Right / Left) */}
      <motion.div
        className="absolute z-10 pointer-events-none"
        style={isMobile
          ? { left: "clamp(-60px, -2vw, 0px)", bottom: "35vh" }
          : { left: "clamp(-60px, -2vw, 0px)", bottom: "clamp(-80px, -10vh, 0px)" }
        }
      ...
      >
        ...
        >
          ...
          >
            <defs>
              <radialGradient id="starGradLeftCard" cx="50%" cy="50%" r="50%">
      ...
      <motion.div
        ...
        className="absolute z-10 pointer-events-none"
        style={{ right: "clamp(-20px, 4vw, 40px)", bottom: "clamp(-20px, 4vh, 40px)" }}
      >
      ...
      >
        <svg viewBox="0 0 1920 1080" preserveAspectRatio="none" fill="none" className="w-full h-full" style={{ filter: "drop-shadow(6px 12px 15px rgba(0,0,0,0.4))" }}>
          <defs>
            <linearGradient id="ribbonGradLeftCard" x1="0%" y1="0%" x2="0%" y2="100%">
          ...
          <path d="M 0 200 C 600 100, 600 400, 250 400 C 100 400, 100 650, 250 650 C 500 650, 400 900, 0 850" stroke="url(#ribbonGradLeftCard)" strokeWidth="32" strokeLinecap="round" style={{ transform: "translate(-4px, -4px)" }} />
      ...
      >
        <svg viewBox="0 0 1920 1080" preserveAspectRatio="none" fill="none" className="w-full h-full" style={{ filter: "drop-shadow(-6px 12px 15px rgba(0,0,0,0.4))" }}>
          <defs>
            <linearGradient id="ribbonGradRightCard" x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="#39FF14" />
          ...
          <path d="M 1400 0 C 1400 300, 900 200, 1100 500 C 1300 500, 1300 700, 1150 700 C 1000 700, 1000 900, 1920 800" stroke="url(#ribbonGradRightCard)" strokeWidth="32" strokeLinecap="round" style={{ transform: "translate(-4px, -4px)" }} />
